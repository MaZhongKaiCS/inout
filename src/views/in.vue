    ...
    <div class="infoBox">
      ...
      <div class="content">
        <p style="text-indent: 2em">
          ...
          同学可于      
          <span id="startTime" style="font-weight: bold">{{ todayYMD }}</span>
          <font class="typeTxt"> 入</font>校。
        </p>
        <div id="remainingTime" class="timeBox loseTime"><span>该凭证<span style="font-weight: bold">{{ fiveMinutes }}</span>后将失效，请尽快入校</span></div>
      </div>
